...
public class NewsDetailsViewPagerFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch(id){//when favorite icon is clicked
            ...
            case R.id.share:
                Firebase ref = new Firebase("https://project-0403.firebaseio.com/news/"+newsType+"/news"+Integer.toString(position+1));
                //Firebase linkRef = ref.child("link");
                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        Log.e("Hola",""+"https://project-0403.firebaseio.com/news"+newsType+"news"+Integer.toString(position+1));
