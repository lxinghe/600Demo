 ...
 */
public class fragment_googleMaps extends Fragment implements
        OnMapReadyCallback,
    ...
    public static fragment_googleMaps newInstance(HashMap<String, String> news){
    ...
    * */
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double eventLong, eventLat;
        eventLocation = (String)news.get("eventLocation");
        eventLong = Double.parseDouble((String) news.get("eventLong"));
        eventLat = Double.parseDouble((String)news.get("eventLat"));
        mMap = googleMap;
        ...
        LatLng location = new LatLng(eventLat, eventLong);
